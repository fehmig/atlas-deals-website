...
import paris from '../../assets/urun1.jpeg'
import NewYork from '../../assets/urun2.jpeg'
import london from '../../assets/urun3.jpeg'
import dubai from '../../assets/urun4.jpeg'
...
const travelers = [
   {
    ...
    images: [sehpa1, sehpa1, sehpa1,sehpa1, sehpa1,sehpa1, sehpa1, ] ,
  ...
  return (
    <div className='travelers container section'>
        <div className="sectionContainer">
            <h2 data-aos="fade-down" data-aos-duration="2500">{translate('productsB')}</h2>
